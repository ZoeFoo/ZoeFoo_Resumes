...
export default function Resumes() {
    const person = {
        ...
        firstName: "Chan",
        lastName: "Siu Ming",
        dateOfBirth: "xth January, 19xx",
        expectedSalary: 25000,
        availability: "immediate",
    };
    const qualities = [
        `Interpersonal skills, Flexibility, Creativity, 
        Willingness to learn, Team player, Handling pressure,
    ...
    const projects = [
        {
            ...
            purpose: "A platform for user to plan travel route for themselves flexibly.",
            skills: [
            ...
            purpose: "A game to make children have fun while learning and practicing sign language.",
            skills: [
        ...
        <div className='relative bg-gradient-to-t from-slate-400 to-white-300'>
            ...
            <div className="flex justify-center mt-[90px] p-5 print:mt-0 p-0">
                <div className='page flex flex-nowrap'>
                    ...
                    <div className='flex flex-col justify-evenly w-3/5 my-[50px] px-[25px] bg-white'>
                        <div>
